...
import { CameraPermissionsModal } from './Settings/CameraPermissionsModal';
...
export const Settings = () => {
    ...
    const openCameraPermissionsModal = (u) => {
        setPermTargetUser(u);
            ...
            <div className="space-y-6">
                {user?.role === 'admin' && (
                    <UserManager
                        ...
                        openCameraPermissionsModal={openCameraPermissionsModal}
